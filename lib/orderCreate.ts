 ...
 * service-role client (scoped to branch_id + job_id within a 45-day
 * rolling window — public.orders has no business_type column) behind
 * a best-effort session check —
